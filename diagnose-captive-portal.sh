...
echo "-----------------"
netstat -tlpn | grep -E ':8080|:80|:53|:67' || echo "No relevant ports found"
...
echo "Can reach web interface: $(curl -s -o /dev/null -w '%{http_code}' http://192.168.4.1:8080 2>/dev/null || echo 'Failed')"
...
echo ""
echo "Common issues:"
echo "1. If port 8080 is not listening -> Flask app not running"
